...
This project implements fully homomorphic encryption (FHE) for study schedule management:

- **Smart Contracts**: Solidity contracts using FHEVM for encrypted data storage
- **Frontend**: Next.js application with MetaMask integration
- **Encryption**: Zama's FHEVM enables computation on encrypted data
- **Storage**: All study data remains encrypted on-chain
