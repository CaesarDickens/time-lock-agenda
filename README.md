...
- **Type-Safe**: Complete TypeScript support throughout the application
...
```bash
# Deploy contract
npx hardhat run tasks/StudySchedule.ts

# Get contract statistics
npx hardhat study-schedule:stats --address <contract-address>

# Verify contract on Etherscan
npx hardhat study-schedule:verify --address <contract-address>
```
...
- Review [Environment Setup](docs/environment-setup.md) for configuration help
